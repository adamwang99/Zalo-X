...
export default function App() {
  ...
  if (initializing) {
    return (
      <div className="h-screen flex flex-col aiw-shell">
        <TopBar />
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <svg className="animate-spin w-10 h-10 mx-auto mb-3" style={{ color: 'var(--aiw-accent-2)' }} viewBox="0 0 24 24" fill="none">
              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
              <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
            </svg>
            <p className="text-sm" style={{ color: 'var(--aiw-muted)' }}>Đang khởi động...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="h-screen flex flex-col aiw-shell overflow-hidden">
      <TopBar />
