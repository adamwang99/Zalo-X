...
const TOOLS_GUIDE = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          'Nhãn Zalo (Zalo Label): đồng bộ 2 chiều với app Zalo trên điện thoại — gán từ Zalo-X, thấy trên Zalo và ngược lại',
          'Nhãn Local: nhãn riêng của Zalo-X, tùy biến màu sắc + emoji, không giới hạn số lượng',
  ...
  },
  {
    ...
    purpose: 'Kết nối Zalo-X với hệ sinh thái bán hàng, thanh toán, vận chuyển Việt Nam. Tra cứu dữ liệu ngay trong khung chat, nhận webhook tự động, kết hợp Workflow để xử lý end-to-end.',
    sections: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          'Cho phép bên ngoài (Casso, SePay, n8n cloud...) gửi webhook về Zalo-X',
...
const COMBO_SCENARIOS = [
  {
    ...
    desc: 'Khách chuyển khoản → Zalo-X nhận webhook từ ngân hàng → Workflow tự động gửi tin xác nhận + gắn nhãn CRM.',
  },
  {
    icon: '🤖',
