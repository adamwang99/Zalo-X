  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Zalo-X cho phép bạn đăng nhập và quản lý <strong >không giới hạn tài khoản Zalo</strong> trong một giao diện duy nhất.
        ...
        <div className="flex items-start gap-3 bg-yellow-900/20 border border-yellow-700/40 rounded-lg px-3 py-2.5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              Zalo-X tập trung vào nhắn tin và Tự động hoá. Các cuộc gọi thoại và video call qua Zalo
...
function ErpPanel() {
  return (
    <div className="space-y-4">
      <Card>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <Paragraph>
              Module ERP giúp đội nhóm quản lý công việc nội bộ ngay trong Zalo-X: từ giao task, theo dõi deadline,
      ...
      <Card>
        <SectionTitle>💡 Khi nào nên dùng ERP trong Zalo-X?</SectionTitle>
        <BulletList items={[
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Zalo-X cho phép tích hợp trực tiếp với các nền tảng POS, thanh toán, vận chuyển và AI phổ biến tại Việt Nam.
      ...
      <Card>
        ...
        <BulletList items={[
          '<strong class="text-gray-200">Webhook server nội bộ:</strong> Zalo-X chạy HTTP server cục bộ (port 9888) để nhận webhook từ Casso, SePay...',
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <Paragraph>
          Zalo-X được xây dựng theo kiến trúc toàn bộ dữ liệu được xử lý và lưu trữ ngay trên máy tính của bạn.
        </Paragraph>
        <BulletList items={[
        ...
        <div className="flex items-start gap-3 bg-yellow-900/20 border border-yellow-700/40 rounded-lg px-3 py-3 mb-2">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              ...
              <code style={{color:'#86efac',background:'#1f2937',padding:'1px 6px',borderRadius:4,margin:'0 3px'}}>C:\Users\...\AppData\Roaming\Zalo-X</code>.
      ...
      <Card>
        ...
        <Paragraph>
          Mặc định, dữ liệu được lưu tại thư mục <code style={{color:'#86efac',background:'#1f2937',padding:'1px 6px',borderRadius:4}}>%AppData%\Zalo-X</code> trên Windows (ổ C).
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <Paragraph>
          Zalo-X hỗ trợ mô hình <strong>1 Boss — nhiều nhân viên</strong>: Boss chạy app trên máy chủ, bật Relay Server,
      ...
      <Card>
        ...
        <StepList steps={[
          ...
          { title: 'Nhân viên cài app riêng', desc: 'Nhân viên cài Zalo-X (phiên bản nhân viên) trên máy của họ, nhập địa chỉ IP:cổng của boss.' },
  ...
  return (
    <div className="space-y-4">
      ...
      <Card>
        ...
        <Paragraph>
          Zalo-X là phần mềm hỗ trợ quản lý giao tiếp trên nền tảng Zalo dành cho mục đích
      ...
      <Card>
        ...
        <BulletList items={[
          ...
          '<strong class="text-gray-200">Không chia sẻ với bên thứ 3</strong>: Zalo-X không tích hợp bất kỳ SDK thu thập dữ liệu, analytics hay quảng cáo của bên thứ 3.',
      ...
      <Card>
        ...
        <BulletList items={[
          'Zalo-X là công cụ hỗ trợ. Người dùng <strong class="text-gray-200">hoàn toàn chịu trách nhiệm</strong> về cách sử dụng phần mềm và tuân thủ pháp luật hiện hành.',
      ...
      <Card>
        ...
        <Paragraph>
          Zalo-X và tất cả tài liệu liên quan là tài sản trí tuệ của <strong >Zalo-X Team</strong>.
      ...
      <Card>
        ...
        <BulletList items={[
          'Link github: <strong class="text-gray-200">https://github.com/adamwang99/Zalo-X</strong>',
        ]} />
      </Card>
    </div>
  );
