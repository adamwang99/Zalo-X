...
const CHANGELOG: VersionEntry[] = [
  ...
  },
  {
    ...
    type: 'major',
    highlights: [
      '🚀 Ra mắt Zalo-X — nền tảng desktop vận hành bán hàng và chăm sóc khách hàng trên Zalo trong một ứng dụng duy nhất',
    ...
    changes: [
      {
        ...
        items: [
          ...
          'Ra mắt ERP nội bộ gồm Task, Calendar, Notes và phân quyền ERP để quản lý giao việc, lịch, tài liệu nội bộ và phối hợp vận hành ngay trong Zalo-X',
