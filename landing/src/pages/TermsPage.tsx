    ...
    <div className="min-h-screen bg-[#060a18] text-white">
      ...
      <nav className="border-b border-white/5 bg-[#060a18]/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 no-underline group">
            <img src="/Zalo-X/icon.png" alt="Zalo-X" className="w-8 h-8 rounded-lg object-contain group-hover:scale-105 transition-transform" />
            <span className="font-bold text-lg text-white tracking-tight">Zalo-X</span>
          </Link>
        ...
        <div className="space-y-8">
          ...
          <section className="glass rounded-2xl border border-white/5 p-6 md:p-8">
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              ...
              <li className="flex items-start gap-2">
                <span className="text-emerald-400 mt-0.5 flex-shrink-0">🔒</span>
                <span><strong className="text-white">Không chia sẻ với bên thứ 3:</strong> Zalo-X không tích hợp bất kỳ SDK thu thập dữ liệu, analytics hay quảng cáo của bên thứ 3.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-400 mt-0.5 flex-shrink-0">🔒</span>
          ...
          <section className="glass rounded-2xl border border-white/5 p-6 md:p-8">
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              <li className="flex items-start gap-2"><span className="text-amber-400 mt-0.5 flex-shrink-0">⚠️</span>
                <span>Zalo-X là công cụ hỗ trợ. Người dùng <strong className="text-white">hoàn toàn chịu trách nhiệm</strong> về cách sử dụng phần mềm và tuân thủ pháp luật hiện hành.</span>
              </li>
              <li className="flex items-start gap-2"><span className="text-amber-400 mt-0.5 flex-shrink-0">⚠️</span>
          ...
          <section className="glass rounded-2xl border border-white/5 p-6 md:p-8">
            ...
            <ul className="space-y-2 text-slate-400 text-sm">
              <li className="flex items-start gap-2"><span className="text-blue-400 mt-0.5">•</span>
                <span>Trong giai đoạn hiện tại, Zalo-X đang được mở để người dùng có thể kích hoạt và sử dụng mà không cần thao tác gia hạn thủ công trên giao diện công khai.</span>
              </li>
              <li className="flex items-start gap-2"><span className="text-blue-400 mt-0.5">•</span>
              ...
              <li className="flex items-start gap-2"><span className="text-blue-400 mt-0.5">•</span>
                <span>Khi chính sách thương mại thay đổi trong tương lai, Zalo-X có thể cập nhật lại giao diện và điều khoản liên quan trước khi áp dụng công khai.</span>
              </li>
            </ul>
          </section>
          ...
          <section className="glass rounded-2xl border border-white/5 p-6 md:p-8">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Zalo-X và tất cả tài liệu liên quan là tài sản trí tuệ của <strong className="text-white">Zalo-X Team</strong>.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-3 bg-gray-800/50 rounded-xl px-4 py-3">
                ...
                <div>
                  ...
                  <a href="https://t.me/babyvibe9" className="text-blue-400 text-sm no-underline hover:underline" target="_blank" rel="noopener noreferrer">@ZaloX_support</a>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-gray-800/50 rounded-xl px-4 py-3">
                <span className="text-2xl">📧</span>
                <div>
                  ...
                  <a href="mailto:ZaloX_support@gmail.com" className="text-blue-400 text-sm no-underline hover:underline">ZaloX_support@gmail.com</a>
                </div>
              </div>
            </div>
          </section>
      ...
      <footer className="border-t border-white/5 bg-[#060a18]">
        <div className="max-w-4xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-600">
          <p>© {new Date().getFullYear()} Zalo-X. All rights reserved.</p>
