        ...
        <div className="mb-16 grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          <div>
            ...
            <p className="text-slate-600 text-lg max-w-2xl aos-element delay-2 leading-relaxed">
              Không chỉ là hiệu ứng kéo-thả: builder của Zalo-X tập trung vào use case vận hành Zalo thực tế — phản hồi lead, theo dõi đơn, chăm sóc sau bán, cảnh báo nội bộ và tích hợp hệ thống ngoài.
            </p>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="flex-shrink-0 text-center md:text-left">
                ...
                <p className="text-slate-600 text-sm mb-5 max-w-xs">
                  Tải Zalo-X, mở Kho mẫu Workflow, chọn & cài đặt chỉ 1 click.
                </p>
                <DownloadDropdown
