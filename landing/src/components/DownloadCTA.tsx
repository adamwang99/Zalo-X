...
const faqs: FaqItem[] = [
  {
    question: 'Zalo-X là gì?',
    answer:
      'Zalo-X là phần mềm quản lý đa tài khoản Zalo trên máy tính. Bạn có thể đăng nhập và sử dụng nhiều tài khoản Zalo cùng lúc trên một giao diện duy nhất — chat, quản lý bạn bè, nhóm, CRM, chiến dịch marketing, tự động hoá workflow, tích hợp các công công cụ bán hàng và  AI Assistant.',
  },
  {
    question: 'Dùng Zalo-X có mất phí không?',
    answer:
  ...
  {
    question: 'Dùng Zalo-X có dùng song song với Zalo Desktop hay Zalo App được không?',
    answer:
        'Có. Chính sách Zalo hỗ trợ mỗi tài khoản đăng nhập đồng thời trên 1 điện thoại, 1 Desktop và 1 Web. Zalo-X sử dụng nền tảng Web của Zalo, vì vậy bạn vẫn dùng bình thường trên Zalo PC và Zalo App. Lưu ý: sau khi đăng nhập vào Zalo-X, bạn sẽ không thể đăng nhập thêm trên Zalo Web (chat.zalo.me) cho cùng tài khoản đó.',
  },
  {
    question: 'Có cho phép nhiều nhân viên hoặc nhiều máy cùng dùng chung 1 tài khoản Zalo không?',
    answer:
        'Có. Zalo-X hỗ trợ mô hình làm việc theo team/workspace, cho phép nhiều nhân viên cùng tham gia vận hành với cơ chế phân quyền rõ ràng. Bạn có thể phân quyền theo nhân viên và theo từng module để mỗi người chỉ thấy và thao tác đúng phần được giao, trong khi quản lý vẫn kiểm soát tập trung toàn bộ hoạt động.',
  },
  {
    question: 'Cài đặt trên hệ điều hành nào?',
    answer:
      'Hiện tại Zalo-X hỗ trợ Windows và macOS. Bộ cài gọn nhẹ khoảng 150MB, khi vận hành thực tế chỉ tiêu thụ khoảng 500MB RAM nên chạy nhanh và ổn định.',
  },
  {
    question: 'Dữ liệu của tôi có an toàn không?',
    answer:
      'Toàn bộ dữ liệu (tin nhắn, liên hệ, ảnh, file…) được lưu trữ trực tiếp trên máy tính của bạn, không qua bất kỳ máy chủ trung gian nào. Zalo-X không thu thập hay chia sẻ dữ liệu cá nhân cho bên thứ ba.',
  },
  {
    question: 'Tài khoản Zalo có bị khoá khi dùng Zalo-X không?',
    answer:
      'Zalo-X hoạt động dựa trên giao thức chính thức của Zalo. Tuy nhiên, bạn nên tránh hành vi spam (gửi tin nhắn hàng loạt quá nhiều trong thời gian ngắn). Phần mềm có cơ chế delay thông minh giúp hạn chế rủi ro bị hạn chế tài khoản.',
  }
];
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="text-center mb-14">
          ...
          <p className="text-slate-600 text-lg max-w-xl mx-auto aos-element delay-2">
            Giải đáp nhanh những thắc mắc phổ biến nhất khi sử dụng Zalo-X.
          </p>
        </div>
          ...
          <div className="stellar-panel rounded-[2rem] p-8 md:p-10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-bold text-slate-950 mb-3">
                Sẵn sàng trải nghiệm <span className="gradient-text">Zalo-X</span>?
              </h3>
