    ...
    <footer className="border-t border-slate-200/80 bg-white/88 backdrop-blur-2xl">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-white shadow-[0_10px_24px_rgba(15,23,42,0.08)] ring-1 ring-slate-200">
                <img src={logo} alt="Zalo-X" className="w-8 h-8 rounded-lg object-contain" />
              </div>
              <span className="font-bold text-lg text-slate-950">Zalo-X</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              {/*</li>*/}
              {[
                { href: 'https://t.me/zaloxCommunity', label: 'Telegram Community & Support' },
                { href: 'https://fb.com/zaloxapp', label: 'Facebook Support' },
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
          <p>© {year} Zalo-X. All rights reserved.</p>
